# Generated by Django 3.2.9 on 2022-01-06 15:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer_status', models.BooleanField(default=False, verbose_name='block')),
                ('device', models.CharField(blank=True, max_length=200, null=True)),
                ('address', models.ManyToManyField(related_name='customer', to='accounts.Address')),
            ],
            options={
